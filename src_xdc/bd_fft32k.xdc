...
###############################
set_clock_groups -name sys_clk -asynchronous -group [get_clocks -of_objects [get_pins bd_fft32k_i/clk_wiz_0/inst/mmcme4_adv_inst/CLKOUT1]]
set_clock_groups -name sys_clk2 -asynchronous -group [get_clocks -of_objects [get_pins bd_fft32k_i/clk_wiz_0/inst/mmcme4_adv_inst/CLKOUT0]]
...
set_property PACKAGE_PIN A20 [get_ports m_rd_tnext_0]
set_property IOSTANDARD LVCMOS33 [get_ports m_rd_tnext_0]
