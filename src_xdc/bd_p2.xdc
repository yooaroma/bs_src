...
###############################
set_clock_groups -name sys_clk -asynchronous -group [get_clocks -of_objects [get_pins bd_p2_i/clk_wiz/inst/mmcme4_adv_inst/CLKOUT1]]
set_clock_groups -name sys_clk2 -asynchronous -group [get_clocks -of_objects [get_pins bd_p2_i/clk_wiz/inst/mmcme4_adv_inst/CLKOUT0]]
