################################################################################
## XDC generated for xczu6cgffvb1156pkg (XCZU6CG-ffvb1156-2-i) device
...
################################################################################
#########################
set_property PACKAGE_PIN AM6 [get_ports {CLK_IN1_D_0_clk_p}]
set_property PACKAGE_PIN AM5 [get_ports {CLK_IN1_D_0_clk_n}]
#########################
...
####################### GT reference clock LOC #######################
#################################################################################
# BANK230 : 228_X1Y4_X1Y7_CLK0_0_X1Y4_DR_AH_L8_L7
# BANK230 : 230_X1Y12_X1Y15_CLK1_3_X1Y15_DR_TE_B10_B9
#################################################################################
#################################################################################
# BANK230 : 228_X1Y4_X1Y7_CLK0_0_X1Y4_DR_AH_L8_L7
#################################################################################
set_property PACKAGE_PIN L8 [get_ports {GT_DIFF_REFCLK1_0_clk_p}]
set_property PACKAGE_PIN L7 [get_ports {GT_DIFF_REFCLK1_0_clk_n}]
#################################################################################
#################################################################################
# BANK230 : 230_X1Y12_X1Y15_CLK1_3_X1Y15_DR_TE_B10_B9
#################################################################################
...
###############################
set_clock_groups -name sys_clk -asynchronous -group [get_clocks -of_objects [get_pins bd_drm_i/clk_wiz/inst/mmcme4_adv_inst/CLKOUT1]]
set_clock_groups -name sys_clk2 -asynchronous -group [get_clocks -of_objects [get_pins bd_drm_i/clk_wiz/inst/mmcme4_adv_inst/CLKOUT0]]
