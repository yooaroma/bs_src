...
# module references:
# bs_gt_reset, bs_usec_reset_n, bs_scb_record_gen, bs_ila_debug, bs_usec_reset_n, bs_scb_record_gen, bs_ila_debug, bs_sw_led, bs_ila_debug, bs_scb_record_gen, bs_usec_reset_n, bs_scb_data_record_pin, bs_scb_data_record_pin, bs_scb_data_record_pin, bs_scb_data_record_pin, bs_scb_data_record_pin, bs_scb_data_record_pin
...
proc create_root_design { parentCell } {
  ...
  if { [catch {set bs_scb_record_gen_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.RECORD_ID {0x1123} $bs_scb_record_gen_0
  ...
  if { [catch {set bs_scb_record_gen_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.RECORD_ID {0x1236} $bs_scb_record_gen_1
  ...
  # Create instance: bs_scb_record_gen_2, and set properties
  set block_name bs_scb_record_gen
  set block_cell_name bs_scb_record_gen_2
  if { [catch {set bs_scb_record_gen_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $bs_scb_record_gen_2 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
    set_property CONFIG.RECORD_ID {0x1335} $bs_scb_record_gen_2
  ...
  connect_bd_intf_net -intf_net bs_scb_record_gen_1_m_axis [get_bd_intf_pins bs_scb_record_gen_1/m_axis] [get_bd_intf_pins aurora_8b10b_1/USER_DATA_S_AXI_TX]
  connect_bd_intf_net -intf_net bs_scb_record_gen_2_m_axis [get_bd_intf_pins bs_scb_record_gen_2/m_axis] [get_bd_intf_pins aurora_8b10b_2/USER_DATA_S_AXI_TX]

  # Create port connections
  connect_bd_net -net aurora_8b10b_0_channel_up [get_bd_pins aurora_8b10b_0/channel_up] [get_bd_pins bs_ila_debug_0/reset_2_n] [get_bd_pins bs_scb_record_gen_0/reset_2_n] [get_bd_pins bs_usec_reset_n_0/channel_up] [get_bd_pins ila_sys/probe0] [get_bd_pins bs_sw_led_0/s_led_1]
  ...
  connect_bd_net -net aurora_8b10b_0_lane_up [get_bd_pins aurora_8b10b_0/lane_up] [get_bd_pins bs_ila_debug_0/reset_1_n] [get_bd_pins bs_scb_record_gen_0/reset_1_n] [get_bd_pins bs_usec_reset_n_0/lane_up] [get_bd_pins ila_sys/probe1]
  ...
  connect_bd_net -net aurora_8b10b_1_channel_up [get_bd_pins aurora_8b10b_1/channel_up] [get_bd_pins bs_ila_debug_1/reset_2_n] [get_bd_pins bs_usec_reset_n_1/channel_up] [get_bd_pins bs_scb_record_gen_1/reset_2_n] [get_bd_pins ila_sys/probe3] [get_bd_pins bs_sw_led_0/s_led_2]
  connect_bd_net -net aurora_8b10b_1_lane_up [get_bd_pins aurora_8b10b_1/lane_up] [get_bd_pins bs_ila_debug_1/reset_1_n] [get_bd_pins bs_usec_reset_n_1/lane_up] [get_bd_pins bs_scb_record_gen_1/reset_1_n] [get_bd_pins ila_sys/probe4]
  connect_bd_net -net aurora_8b10b_1_user_clk_out [get_bd_pins aurora_8b10b_1/user_clk_out] [get_bd_pins bs_ila_debug_1/Clk] [get_bd_pins bs_scb_record_gen_1/Clk]
  connect_bd_net -net aurora_8b10b_2_channel_up [get_bd_pins aurora_8b10b_2/channel_up] [get_bd_pins bs_ila_debug_2/reset_2_n] [get_bd_pins bs_usec_reset_n_2/channel_up] [get_bd_pins bs_scb_record_gen_2/reset_2_n] [get_bd_pins ila_sys/probe6] [get_bd_pins bs_sw_led_0/s_led_3]
  connect_bd_net -net aurora_8b10b_2_lane_up [get_bd_pins aurora_8b10b_2/lane_up] [get_bd_pins bs_ila_debug_2/reset_1_n] [get_bd_pins bs_usec_reset_n_2/lane_up] [get_bd_pins bs_scb_record_gen_2/reset_1_n] [get_bd_pins ila_sys/probe7]
  connect_bd_net -net aurora_8b10b_2_user_clk_out [get_bd_pins aurora_8b10b_2/user_clk_out] [get_bd_pins bs_ila_debug_2/Clk] [get_bd_pins bs_scb_record_gen_2/Clk]
  connect_bd_net -net bitvector_1 [get_bd_pins bs_ila_debug_1/ila_data] [get_bd_pins rx_ila_1/bitvector]
  connect_bd_net -net bitvector_2 [get_bd_pins bs_scb_record_gen_1/m_record_data] [get_bd_pins gen_ila_1/bitvector]
  connect_bd_net -net bitvector_3 [get_bd_pins bs_ila_debug_2/ila_data] [get_bd_pins rx_ila_2/bitvector]
  connect_bd_net -net bs_gt_reset_0_reset [get_bd_pins bs_gt_reset_0/reset] [get_bd_pins aurora_8b10b_0/reset] [get_bd_pins aurora_8b10b_1/reset] [get_bd_pins aurora_8b10b_2/reset]
  connect_bd_net -net bs_gt_reset_0_reset_gt [get_bd_pins bs_gt_reset_0/reset_gt] [get_bd_pins aurora_8b10b_0/gt_reset] [get_bd_pins aurora_8b10b_1/gt_reset] [get_bd_pins aurora_8b10b_2/gt_reset]
  ...
  connect_bd_net -net bs_scb_record_gen_2_m_record_data [get_bd_pins bs_scb_record_gen_2/m_record_data] [get_bd_pins gen_ila_2/bitvector]
